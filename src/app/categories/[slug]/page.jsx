...
import { formatDate, getBlogPostsWithCategory } from "@/app/blog/utils";
...
const page = ({ params }) => {
  ...
  if (allBlogs.length < 1) {
    return <div className="w-full h-[70vh] flex justify-center items-center">No Posts with {decodeURIComponent(params.slug)} category. </div>;
    // notFound();
  }

...
tags: "columns, content-2, nextjs, react, speed-optimization"
---
...
**But wait there is more!**  We also have a block called _Media & Text,_ which is a two column block that helps you display media and text content next to each other, without having to first setup a column block:
